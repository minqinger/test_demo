<template>
  <div class="l-content">
    <div class="cell">
      <div class="cell-1">
        <div class="label">嘱托对象</div>
        <div class="value">{{ defaultData.xm }}</div>
      </div>
      <div class="cell-1">
        <div class="label">嘱托时间</div>
        <div class="value">{{ formatDate(defaultData.ywsj, 'YYYY 年 MM 月 DD 日') }}</div>
      </div>
    </div>
    <div class="cell">
      <div class="label">嘱托形式</div>
      <div class="value">{{  defaultData.ztxs }}</div>
      <!-- <div class="value">{{ mixinGetValueByDictionary('ztxs', defaultData.ztxs) }}</div> -->
    </div>
    <div class="cell">
