  ...
  <div class="l-content">
    <div class="cell">
      ...
      <div class="cell-1">
        ...
        <div class="value">{{ defaultData.ch }}</div>
      </div>
    </div>
    <div class="cell">
      <div class="label">登记人员</div>
      <div class="value">{{ defaultData.djr }}</div>
    </div>
    <div class="cell">
      <div class="label">监控时间</div>
      <div class="value">{{ formatDate(defaultData.ywsj, 'YYYY 年 MM 月 DD 日 HH 时 mm 分 ss 秒') }}</div>
    </div>
